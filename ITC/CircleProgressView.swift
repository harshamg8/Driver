...
@objc @IBDesignable open class CircleProgressView: UIView {
    ...
    @IBInspectable open var trackWidth: CGFloat = 50 {
        didSet { setNeedsDisplay() }
    }
    ...
    @IBInspectable open var trackFillColor: UIColor = UIColor.rgb(red: 184, green: 41, blue: 37) {
        didSet { setNeedsDisplay() }
    }

    @IBInspectable open var trackBorderColor:UIColor = UIColor.black {
        didSet { setNeedsDisplay() }
    }
    ...
    override open func draw(_ rect: CGRect) {
        ...
        internalProgress = (internalProgress/36.0) == 1.0 ? constants.maximumValue : internalProgress
