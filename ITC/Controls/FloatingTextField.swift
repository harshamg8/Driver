...
open class FloatingTextField: UITextField {
    ...
    @IBInspectable dynamic open var isEmailType: Bool = false
    @IBInspectable dynamic open var isMandatory: Bool = false
    ...
    //Color for selected field title
    ...
    //Line height for selected state
    ...
    */
    ...
    fileprivate func createLineView() {
        ...
        lineView.frame = CGRect(x: lineView.frame.origin.x, y: lineView.frame.origin.y - 10, width: lineView.frame.size.width, height: lineView.frame.size.height)
        addSubview(lineView)
    }
    ...
    */
    open func titleLabelRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        if editing {
            return CGRect(x: 0, y: -20, width: bounds.size.width, height: titleHeight())
        }
    ...
    open func lineViewRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        ...
        return CGRect(x: 0, y: bounds.size.height - height + 4, width: bounds.size.width, height: height)
    }
